            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="space-y-1">
                ...
                <div className="relative">
                  <User className="w-4 h-4 text-slate-500 dark:text-slate-400 absolute left-3.5 top-3.5" />
                  <input
                    type="text"
                    required
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <Lock className="w-4 h-4 text-slate-500 dark:text-slate-400 absolute left-3.5 top-3.5" />
                  <input
                    type="password"
                    required
                    placeholder="••••••••••••"
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-full text-xs font-bold text-slate-900 dark:text-white bg-[#FF5B22] hover:bg-[#e54c15] shadow-lg shadow-orange-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
