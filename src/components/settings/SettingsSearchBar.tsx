  ...
  return (
    <div className="relative w-full text-xs font-sans">
      ...
      <input
        ...
        className="w-full pl-10 pr-9 py-3 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-purple-500 transition-colors shadow-sm font-medium"
      />
      {searchQuery && (
        <button
