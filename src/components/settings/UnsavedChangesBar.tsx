...
export const UnsavedChangesBar: React.FC<UnsavedChangesBarProps> = ({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-white dark:bg-slate-900 border-2 border-[#00a896] text-slate-900 dark:text-white px-5 py-3 rounded-2xl shadow-2xl flex items-center gap-4 text-xs font-sans animate-in slide-in-from-bottom-5 duration-200">
      ...
      <div className="flex items-center gap-2 font-sans font-extrabold">
        ...
        <button
          onClick={onSave}
          className="px-4 py-1.5 rounded-xl bg-[#00a896] opacity-90 hover:opacity-100 text-white flex items-center gap-1 transition-colors cursor-pointer shadow-md"
        >
