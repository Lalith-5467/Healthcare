      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="relative rounded-2xl overflow-hidden p-8 bg-slate-900 text-white shadow-lg group border border-slate-800 flex flex-col justify-between min-h-[220px]"
          >
          ...
          <motion.div 
            ...
            className="relative rounded-2xl overflow-hidden p-8 bg-gradient-to-br from-[#00a896] to-[#0284c7] text-white shadow-lg group flex flex-col justify-between min-h-[220px]"
          >
            <div className="relative z-10 space-y-3">
            ...
            <div className="relative z-10 pt-4 flex items-center justify-between">
              <a 
                ...
                className="inline-flex items-center gap-2 text-base font-extrabold text-white bg-white/20 hover:bg-white/30 px-4 py-2 rounded-xl transition-all"
              >
