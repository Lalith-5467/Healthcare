    ...
    <div className="relative group">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute top-0 left-0 h-1 bg-gradient-to-r from-[#00a896] via-teal-400 to-cyan-400 rounded-t-full shadow-sm"
        />

        {/* CARD HEADER: ICON + CATEGORY + STEP CHIP */}
          ...
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 ${
              isHovered 
                ...
                : 'bg-teal-500/10 dark:bg-teal-500/20 text-[#00a896] dark:text-cyan-400 border border-teal-500/25'
            }`}>
