        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-slate-800 hover:bg-[#00a896] text-xs font-bold text-slate-300 hover:text-white transition-all flex items-center gap-1.5 cursor-pointer shadow-md hover:shadow-teal-500/20"
            >
