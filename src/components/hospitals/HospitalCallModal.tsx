      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl relative">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-lg font-extrabold text-slate-900 dark:text-white">Call Hospital</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">Contact {hospital.name}</p>
            </div>
          </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-2 text-center">
          ...
          <h4 className="text-xl font-extrabold text-emerald-600 dark:text-emerald-400 font-mono">{hospital.phone}</h4>
          <p className="text-[11px] text-slate-600 dark:text-slate-300">{hospital.openingHours}</p>
        </div>
