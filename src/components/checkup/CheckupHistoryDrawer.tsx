...
export const CheckupHistoryDrawer: React.FC<CheckupHistoryDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/60 dark:bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200 font-sans">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 w-full max-w-md max-h-[90vh] rounded-3xl flex flex-col justify-between shadow-2xl p-6 overflow-y-auto text-slate-900 dark:text-white relative">
        {/* HEADER */}
