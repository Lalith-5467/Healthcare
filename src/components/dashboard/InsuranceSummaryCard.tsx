    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-xs text-slate-300 font-mono">CarePlus Family Floater</span>
          </div>
        </div>

        <span className="px-3 py-1 text-[10px] font-black uppercase bg-emerald-500/20 text-emerald-300 rounded-full border border-emerald-500/30 font-mono">
          ● Active Coverage
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 font-mono">
        <div className="p-3 bg-slate-950/80 rounded-2xl border border-slate-800 space-y-0.5">
          <span className="text-[10px] text-slate-300 uppercase font-sans font-bold block">Total Coverage</span>
          <strong className="text-lg font-black text-white font-sans">₹10,00,000</strong>
        </div>

        <div className="p-3 bg-slate-950/80 rounded-2xl border border-slate-800 space-y-0.5">
          <span className="text-[10px] text-slate-300 uppercase font-sans font-bold block">Policy Expiry</span>
          <strong className="text-sm font-bold text-amber-300">31 Dec 2026</strong>
        </div>
      </div>
