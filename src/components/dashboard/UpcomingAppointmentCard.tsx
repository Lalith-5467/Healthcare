    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-xs font-bold text-blue-600 dark:text-cyan-300 font-mono">
        ...
        <div className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-cyan-300 border border-blue-500/30 text-xs font-mono font-bold flex items-center gap-1.5 shadow-sm">
          <Clock className="w-4 h-4 text-blue-500 dark:text-cyan-400 animate-spin-slow" />
      ...
      <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 flex items-center gap-3.5 shadow-inner">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-[10px] text-slate-500 dark:text-slate-300 mt-1 font-mono font-bold">
            <span className="flex items-center gap-1 text-blue-600 dark:text-cyan-300">
