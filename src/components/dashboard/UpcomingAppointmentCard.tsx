    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-xs font-bold text-blue-700 dark:text-cyan-300 font-mono">
        ...
        <div className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-700 dark:text-cyan-300 border border-blue-500/30 text-xs font-mono font-bold flex items-center gap-1.5 shadow-sm">
          <Clock className="w-4 h-4 text-blue-600 dark:text-cyan-400 animate-spin-slow" />
          <span>{isReady ? 'Ready!' : `${pad(hours)}h ${pad(minutes)}m ${pad(secs)}s`}</span>
        </div>
      </div>

      {/* DOCTOR DETAILS */}
      <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 flex items-center gap-3.5 shadow-inner">
        <img
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-slate-600 dark:text-slate-300 font-medium">Senior General Physician</p>
          <div className="flex items-center gap-2 text-[10px] text-slate-600 dark:text-slate-300 mt-1 font-mono font-bold">
            <span className="flex items-center gap-1 text-blue-700 dark:text-cyan-300">
      ...
      <div className="flex items-center gap-3 pt-1">
        <motion.button
          ...
          className="flex-1 py-2.5 px-3 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-extrabold border border-slate-300 dark:border-slate-700 transition-all flex items-center justify-center gap-1 cursor-pointer shadow"
        >
