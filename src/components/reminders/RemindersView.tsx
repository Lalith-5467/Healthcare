    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-300 pb-20 font-sans bg-slate-50/50 rounded-[2.5rem] p-2 sm:p-6 -mx-2 sm:-mx-6">
      ...
      <div className="space-y-6 pt-8 border-t border-slate-200">
        ...
        {futureReminders.length === 0 ? (
          <div className="bg-white rounded-3xl border border-slate-200 p-8 text-center shadow-md">
            <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mb-3 mx-auto">
            ...
            <p className="text-xs text-slate-500 font-medium">Your confirmed future appointments and medication reminders will appear here automatically.</p>
          </div>
        ) : (
      ...
      <div className="space-y-6 pt-8 border-t border-slate-200">
        ...
        {completedAndHistoryReminders.length === 0 ? (
          <div className="bg-white rounded-3xl border border-slate-200 p-6 text-center text-slate-500 text-xs font-semibold">
