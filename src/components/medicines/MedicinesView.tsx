      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Medicines</h1>
            <span className="px-3 py-1 text-xs font-extrabold bg-amber-500/20 text-amber-300 border border-amber-500/30 rounded-full">
              Pill Tracker
            </span>
          </div>
          <p className="text-xs sm:text-sm text-slate-400 mt-1">
            Stay on track with your medications and daily treatment schedule.
          </p>
        </div>
