    ...
    <div className="bg-white dark:bg-slate-900/90 border border-slate-200/90 dark:border-slate-800 rounded-3xl p-5 space-y-5 shadow-xl text-xs font-sans text-slate-900 dark:text-white">
      ...
      <div className="text-center space-y-3 p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800">
        <div className="relative inline-block">
          <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-[#00a896] via-teal-500 to-cyan-600 border-2 border-teal-300/40 flex items-center justify-center text-white text-3xl shadow-lg mx-auto">
      ...
      <button
        onClick={onNewChat}
        className="w-full py-2.5 px-4 rounded-2xl font-extrabold text-xs text-white bg-gradient-to-r from-[#00a896] to-teal-600 hover:from-[#00897b] hover:to-teal-700 transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
      >
