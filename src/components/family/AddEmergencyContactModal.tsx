      ...
      <div className="bg-white border border-slate-200 rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl relative">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-lg font-extrabold text-slate-900">Add Emergency Contact</h3>
              <p className="text-xs text-slate-500">Configure emergency phone contact info</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            <label className="block text-slate-500 font-bold uppercase tracking-wider mb-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-slate-500 font-bold uppercase tracking-wider mb-1.5">Relationship</label>
              <input
                type="text"
                value={relationship}
            ...
            <div>
              <label className="block text-slate-500 font-bold uppercase tracking-wider mb-1.5">Priority</label>
              <select
                value={priority}
          ...
          <div>
            <label className="block text-slate-500 font-bold uppercase tracking-wider mb-1.5">Phone Number</label>
            <input
              type="text"
              required
              value={phone}
              ...
              className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 font-mono text-xs font-bold focus:outline-none focus:border-[#00a896]"
            />
          </div>
