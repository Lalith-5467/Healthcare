      ...
      <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-md h-auto max-h-[90vh] flex flex-col justify-between shadow-2xl p-6 overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-4 shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-lg font-extrabold text-slate-900">Filter Family Activities</h3>
              <p className="text-xs text-slate-500">Filter shared items by member & activity type</p>
            </div>
          </div>
          <button
            onClick={onClose}
