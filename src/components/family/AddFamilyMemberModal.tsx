      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl relative">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-[10px] font-bold uppercase tracking-wider text-cyan-400">Step {step} of 2</span>
        ...
        {sentSuccess ? (
          <div className="py-6 text-center space-y-4">
            ...
            <div>
              <h4 className="text-base font-extrabold text-white">Invitation Sent Successfully</h4>
              <p className="text-xs text-slate-300 mt-1">
                Your family member <strong className="text-white">{fullName}</strong> ({relationship}) has been added to pending connections.
              </p>
            </div>
            <button
              onClick={handleDone}
            ...
            {step === 1 ? (
              <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-slate-300 font-bold uppercase tracking-wider mb-1.5">Age (Optional)</label>
                    <input
                      type="number"
                      value={age}
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. family.member@example.com or +91 98765 43210"
                    className="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white font-semibold text-sm focus:outline-none focus:border-[#00a896]"
                  />
                </div>

                <div className="p-3.5 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 text-[11px] text-cyan-300">
