...
import { 
  ...
  ArrowUpRight, HeartPulse, Clock, Sparkles, ShieldCheck, Lock, Check, XCircle
} from 'lucide-react';
...
export const DoctorOverviewView: React.FC<DoctorOverviewViewProps> = ({ 
  ...
  useEffect(() => {
    fetchDoctorRequests();
    const interval = setInterval(fetchDoctorRequests, 8000); // Polling for real-time updates
