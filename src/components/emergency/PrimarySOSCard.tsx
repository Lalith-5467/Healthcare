...
export const PrimarySOSCard: React.FC<PrimarySOSCardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-b from-slate-900 via-slate-900 to-rose-950/40 border-2 border-rose-500/40 rounded-3xl p-6 sm:p-10 space-y-6 text-center shadow-2xl relative overflow-hidden">
      ...
      <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-rose-500/10 text-rose-300 border border-rose-500/30 text-[11px] font-extrabold font-mono uppercase tracking-wider relative z-10">
        <ShieldAlert className="w-3.5 h-3.5" />
        <span>Demo Mode — Safe Interactive Simulation</span>
      </div>

      <div className="space-y-2 max-w-md mx-auto relative z-10">
        <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">Emergency Assistance</h2>
