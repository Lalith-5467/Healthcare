      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-extrabold text-white">Add New Allergy</h3>
          </div>

          <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
            <div>
              <label className="block font-bold text-slate-300 mb-1">Allergy Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div>
              <label className="block font-bold text-slate-300 mb-1">Reaction Symptoms</label>
              <input
                type="text"
                value={reaction}
