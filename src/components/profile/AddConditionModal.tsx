      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md font-sans">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-extrabold text-slate-900 dark:text-white">Add Chronic Condition</h3>
          </div>

          <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
            <div>
              <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Condition Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div>
              <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Current Status</label>
              <select
                value={status}
