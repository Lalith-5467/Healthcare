    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex justify-center items-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg h-auto max-h-[90vh] bg-white dark:bg-[#0b1120] border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 shadow-2xl rounded-2xl flex flex-col z-50 select-none overflow-hidden"
        >
          {/* HEADER */}
          ...
          {/* TAB NAVIGATION */}
          <div className="px-6 pt-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2 bg-white dark:bg-[#0b1120] shrink-0">
            <button
          ...
          <form id="edit-profile-form" onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto text-sm">
            {activeTab === 'personal' ? (
              <>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-950 focus:outline-none focus:ring-2 focus:ring-[#00a896]/50 focus:border-[#00a896] transition-all"
                  />
                </div>

                <div className="grid grid-cols-3 gap-4">
                  <div className="col-span-3 sm:col-span-1">
                    <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1.5">Date of Birth</label>
                    <input
                      type="text"
                      value={formData.dob}
                  ...
                  <div className="col-span-1">
                    <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1.5">Age</label>
                    <input
                      type="number"
                      value={formData.age}
                      onChange={(e) => handleChange('age', parseInt(e.target.value) || 0 as any)}
                      className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:bg-white dark:focus:bg-slate-950 focus:outline-none focus:ring-2 focus:ring-[#00a896]/50 focus:border-[#00a896] transition-all"
                    />
                  </div>

                  <div className="col-span-2 sm:col-span-1">
                    <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1.5">Gender</label>
                    <select
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1.5">Location / City</label>
                  <input
                    type="text"
              ...
              <>
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1.5">Blood Group</label>
                  <select
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1.5">Height</label>
                    <input
                      type="text"
          ...
          {/* FOOTER ACTIONS */}
          <div className="p-6 border-t border-slate-100 dark:border-slate-800 flex items-center gap-3 bg-white dark:bg-[#0b1120] shrink-0">
            <button
              type="button"
              onClick={onClose}
