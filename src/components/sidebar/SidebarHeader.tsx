  ...
  return (
    <div className="p-3.5 flex items-center justify-between border-b border-slate-200/90 dark:border-slate-800/60 relative shrink-0">
      <div className="flex items-center gap-2.5 overflow-hidden select-none">
        ...
        <div className="relative shrink-0 flex items-center justify-center w-9 h-9 rounded-2xl bg-rose-500/20 text-rose-500 dark:text-rose-400 border border-rose-500/30 shadow-md shadow-rose-500/10 group">
          ...
          <Heart className="w-5 h-5 relative z-10 fill-rose-500/30 text-rose-500 dark:text-rose-400 stroke-[2.5]" />
        </div>

        {/* BRAND NAME & SUBTITLE */}
        {!isCollapsed && (
          <div className="flex flex-col min-w-0 transition-all duration-300">
            <span className="font-extrabold text-base tracking-tight text-slate-900 dark:text-white leading-tight flex items-center gap-1">
              Health<span className="text-[#00a896]">Record</span>
            </span>
            <span className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 tracking-tight leading-tight mt-0.5">
