      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md font-sans">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-extrabold text-slate-900 dark:text-white">Delete Medical Record</h3>
              <p className="text-xs text-rose-600 dark:text-rose-400 font-semibold">Destructive Action</p>
            </div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 space-y-1 text-xs">
            <span className="font-extrabold text-slate-900 dark:text-white block">{record.title}</span>
            <p className="text-slate-500 dark:text-slate-400">{record.type} • {record.date} • {record.hospital}</p>
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            <button
              onClick={onClose}
              className="flex-1 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-white font-bold text-xs transition-all cursor-pointer border border-slate-200 dark:border-slate-700"
            >
              Cancel
            </button>
